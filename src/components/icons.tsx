...
export function StarIcon({ size = 13, ...props }: IconProps) {
  return (
...
export function StarFilledIcon({ size = 12, ...props }: IconProps) {
  return (
...
export function MapPinIcon({ size = 12, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function RefreshIcon({ size = 14, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M3.51 9A9 9 0 0118.36 5.64L23 10" />
    </svg>
  )
}

export function WarningIcon({ size = 11, ...props }: IconProps) {
  return (
...
export function ArrowRightIcon({ size = 12, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function XIcon({ size = 12, ...props }: IconProps) {
  return (
